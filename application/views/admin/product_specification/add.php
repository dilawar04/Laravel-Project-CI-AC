                ...
                <div class="col-md-6">
                  <h4>Basic Information</h4>            
                    <div class="row form-row">
                      <div class="col-md-12">
                        <input name="product_id" id="product_id" type="text"  class="form-control <?php echo form_error('product_id') ? 'error' : NULL ?>" placeholder="Create Date" value="<?php echo set_value('product_id'); ?>">

              ...
              <div class="row column-seperation">
                <div class="col-md-6">
                  <h4>Basic Information</h4>            
                    ...
                    <div class="row form-row">
                      <div class="col-md-12">
                        <select name="media_type" id="media_type" class="form-control">
                          ...
                          <option value="video" <?php echo ($media->media_type == 'video') ? 'selected' : NULL ?>>Vedio</option>
                        </select>
                      </div>
                    </div>
                    <div class="row form-row">
                    ...
                    <div class="row form-row">
                      <div class="col-md-12">
                        <textarea name="description" id="description" rows="8" class="form-control" placeholder="Description" value="<?php echo $media->description; ?>"></textarea>
                      </div>
                    </div>
                    <div class="row form-row">
                      <div class="col-md-12">
                        <textarea name="embed_code" id="embed_code" rows="8" class="form-control" placeholder="Embed Code" value="<?php echo $media->embed_code; ?>"></textarea>
                      </div>
                    </div>
                </div>
                <div class="col-md-6">
